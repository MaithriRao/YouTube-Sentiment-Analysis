...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyAXDaz1G_JlYnq11KwTfLmDKygmghUM2Xo';
  // const API_KEY = process.env.API_KEY;  // access env variable (YouTube Data API key)  
  const API_URL = 'http://localhost:5000';
  // const API_URL = 'http://ec2-13-53-131-93.eu-north-1.compute.amazonaws.com:5000';
